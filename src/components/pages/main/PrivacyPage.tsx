          ...
          topicList={[
            {
              ...
              content: (
                <div>
                  제1조 (목적) <br />
                  본 개인정보 처리방침은 정주행 한국사(이하 "회사"라 함)가
                  회원의 개 인정보를 수집, 이용, 관리, 보호하는 것을 목적으로
                  합니다.` <br />
                  ...
                  이용합니다. 서비스 제공을 위한 회원 식별 및 인증 서비스 이용
                  및 문의사항 처리 새로운 서비스 및 이벤트 안내 마케팅 및 광고
                  활용을 위한 통계 및 분석 자료 작성 <br /> <br />제 4조
                  (개인정보의 보유 및 이용기간) <br /> 회사는 회원의 개인정보를
                  회원 탈퇴 시까지 보유 및 이용하며, 다 만 관계법령에 따라
                  ...
                  제 6조 (개인정보의 파기)
                  <br />
                  회사는 회원의 개인정보가 수집 및 이용목적을 달성한 후에는 지
                  체 없이 파기합니다. 단, 관계 법령에 따라 보존할 필요가 있는 경
                  우에는 회원의 개인정보를 보관합니다. 제7조 (회원의 권리)
                  회원은 언제든지 자신의 개인정보에 대해 열람, 정정, 삭제를 요청
                  할 수 있습니다. 또한 회사는 회원의 요청에 따라 개인정보의 오류
                  를 정정하거나 삭제해야 할 경우 지체 없이 조치합니다. <br />{" "}
                  <br />제 8조 (개인정보보호책임자) <br /> 회원은 회사의
                  개인정보 처리에 관한 불만이 있거나 개인정보보호 관련
                  문의사항이 있는 경우 회사의 개인정보보호책임자에게 문의 할 수
                  있습니다. <br />
                  ...
                  사유로 개인 정보 처리방침을 변경할 수 있습니다. 변경된
                  개인정보 처리방침 은 회사의 홈폐이지 등을 통해 공지됩니다.{" "}
                  <br />
                  <br />제 10 조 (기타)
